...
player_data <- read_parquet("https://github.com/bit-in-that/data-automation/raw/main/2026/output/sc_player_data.parquet")
player_selections_long <- read_parquet("https://github.com/bit-in-that/data-automation/raw/main/2026/output/sc_player_selections_long.parquet")
...
system.time({
  iwalk(ownership_adjusted_plot_data,~ write_json(.x, paste0("fantasy/2026/json_data/sc_ownership_adjusted_plot_data/", .y, ".json")))
})
