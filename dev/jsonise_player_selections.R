...
create_text_role_label <- function(snapshot_date, metric_value, metric_label, official_value, completion_value, completion_label = NULL) {
  ...
  paste0("Snapshot Date: ", format(snapshot_date, format = "%Y-%m-%d"), "<br />", metric_label, ": ", round(metric_value, 2), "% (normalised for: ", round(100*completion_value, 1), "% ", completion_label, ")<br />Official: ", official_value, "%")
