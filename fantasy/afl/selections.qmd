...
player_selections_table |> 
  reactable(
    columns = list(
      ...
      full_name = colDef(name = "Player", cell = \(cell_value, row_index) {
    ...
    columnGroups = list(
      ...
      colGroup(name = "Change Adjusted in Ownership", columns = c("change_yesterday", "change_week", "change_max", "change_max_date"))
    ),
    filterable = TRUE
  )
