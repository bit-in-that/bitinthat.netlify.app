...
ranking_data |> 
  ...
  select(teamName, overallRank, totalPoints, teamValue, value_rank) |> 
    reactable(
    columns = list(
      teamName = colDef(
        name = "Fantasy Team",
      ...
      overallRank = colDef(name = "Rank", width = 100, format = colFormat(separators = TRUE)),
      totalPoints = colDef(name = "Points", width = 100, format = colFormat(separators = TRUE)),
...
ranking_data |> 
  ...
  select(teamName, teamValue, value_rank, overallRank, totalPoints) |> 
    reactable(
    columns = list(
      teamName = colDef(
        name = "Fantasy Team",
