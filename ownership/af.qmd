...
When people look at the ownership percentages for AFL fantasy, they often wonder why the most selected players are all below 70% (people usually assume this is because there are a lot of casuals or autofill teams out there). The reason for this is that a lot of teams are either missing players or are entirely empty. Fortunately there is a solution to this, I have devised the following formula to calculate a player's true selected number:
