...
$$\text{Priced at}_r = \frac{\text{Price}_r}{\text{Magic Number}_r} \quad \text{for Round } r$$
:::
...
$$\text{Bailey Smith Initial "Priced at"} = \frac{1{,}220{,}000}{10{,}490} = \mathbf{116.3}$$
...
$$\text{Magic Number}_r = \frac{\sum \text{prices}_r}{\sum \text{weighted avg scores}_r} \quad \text{for all players who played in Round } r$$
:::
...
::: {.equation-block}
$$\frac{1800\%}{23} = \mathbf{78.3\%} \text{ average TOG per player}$$
:::
